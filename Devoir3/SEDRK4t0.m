function qs=SEDRK4t0(q0,t0,Deltat,g, masse, aire)
...
k1=feval(g,q0,t0, masse, aire);
k2=feval(g,q0+k1*Deltat/2,t0+Deltat/2, masse, aire);
k3=feval(g,q0+k2*Deltat/2,t0+Deltat/2, masse, aire);
k4=feval(g,q0+k3*Deltat,t0+Deltat, masse, aire);
